...
<div class="container-fluid">
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            <div class="text-center mb-5">
                ...
                <h1>Esta es tus calificaciones y horarios</h1>
            </div>
    ...
    if ($alumno_encontrado) {
        ?>
        <h3>Horarios del Alumno: <?php echo $_SESSION['nombre']; ?></h3>
        <table class="table">
            <thead>
            <tr>
            ...
            while ($fila = $resultado_horarios->fetch_assoc()) {
                ...
                // Convierte el número de día de la semana a su nombre correspondiente
        ...
        <h3>Calificaciones del Alumno: <?php echo $_SESSION['nombre']; ?></h3>
        <table class="table">
            <thead>
            <tr>
            ...
            <tbody>
            <?php
            // Mostrar las calificaciones del alumno
